    ...
    <div className="card" style={{ gridColumn: '1 / -1', borderLeft: '3px solid rgba(239,68,68,0.4)' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.28)', marginTop: 2 }}>Export or permanently delete your data</div>
        </div>
      </div>

      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12 }}>
        <div style={{ flex: '1 1 260px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, background: '#08081A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 11, padding: '13px 16px' }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.85)' }}>Export your data</div>
            <div style={{ fontSize: 10.5, color: 'rgba(255,255,255,0.32)', marginTop: 1 }}>Download everything as JSON</div>
          </div>
          <Button
            variant="secondary"
        ...
        <div style={{ flex: '1 1 260px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, background: 'rgba(239,68,68,0.05)', border: '1px solid rgba(239,68,68,0.15)', borderRadius: 11, padding: '13px 16px' }}>
          <div>
            <div style={{ fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.85)' }}>Delete account</div>
            <div style={{ fontSize: 10.5, color: 'rgba(255,255,255,0.32)', marginTop: 1 }}>Permanently erase all your content and data</div>
          </div>
          <Button
            variant="danger"
            icon={<Trash2 size={13} />}
